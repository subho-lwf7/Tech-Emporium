...
<%@page import="com.mycompany.techemporium.helper.Helper"%>
<%@page import="com.mycompany.techemporium.entities.Category"%>
<%@page import="com.mycompany.techemporium.dao.CategoryDao"%>
<%@page import="com.mycompany.techemporium.entities.Product"%>
<%@page import="java.util.List"%>
<%@page import="com.mycompany.techemporium.dao.ProductDao"%>


<%@page import="com.mycompany.techemporium.helper.FactoryProvider"%>
...
<html>
    <head>
        ...
        <title>Tech Emporium - Home </title>
